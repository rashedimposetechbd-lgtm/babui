...
export default function Navigation({ cartItemCount = 0 }: NavigationProps) {
  ...
  return (
    <>
      <div className="gb-topbar w-full bg-emerald-800 text-emerald-100 text-xs py-1.5 border-b border-emerald-700/50">
      ...
      {isMobileMenuOpen && (
        <div
          className="fixed inset-0 bg-black/50 backdrop-blur-xs z-[1050] md:hidden"
      ...
      {/* Mobile Drawer Menu */}
      <div
        className={`fixed top-0 left-0 bottom-0 w-80 max-w-[85vw] bg-white dark:bg-slate-900 z-[1050] shadow-2xl transition-transform duration-300 ease-in-out md:hidden flex flex-col ${
